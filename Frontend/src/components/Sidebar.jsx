  ...
  return (
    <div className="w-74 bg-gray-900 text-white min-h-screen flex flex-col shadow-xl fixed left-0 top-0 z-50">
      ...
      <nav className="mt-6 flex-1 overflow-y-auto">
        ...
        <ul className="space-y-1 px-4">{surveyNavItems.map(renderNavLink)}</ul>
        ...
        <ul className="space-y-1 px-4">{subjectNavItems.map(renderNavLink)}</ul>
      ...
      <div className="p-6 border-t border-gray-800">
        {onLogout && (
          <button
            onClick={onLogout}
            className="w-full mb-6 px-4 py-2 border border-blue-500 text-blue-400 hover:bg-blue-600 hover:text-white rounded-lg transition-all text-sm font-medium flex items-center justify-center gap-2"
          >
            <svg
              className="w-4 h-4"
              fill="none"
        ...
        <p className="text-xs font-bold tracking-tight text-gray-400">
          ...
          <a
            target="_blank"
            href="https://dushanportfolio.textaworld.com/"
            className="text-blue-400 hover:underline"
          >
            Dushan
          </a>{" "}
        </p>
        <p className="text-xs font-bold tracking-tight text-gray-500">
          Version 1.0.0
        </p>
      </div>
    </div>
